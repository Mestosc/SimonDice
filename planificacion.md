# Planificacion para implementacion de funcionalidades

Aqui se exponen una serie de normas para la planificacion:

- La planificacion debera ser volcada a un archivo en markdown llamado `planificacion-COSAIMPLEMENTAR.md` donde COSAIMPLEMENTAR es la funcionalidad a implementar y que debera estar en una carpeta `plannings`
